...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.onChange = function (event, directName) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, values, errors, name, value, nextState, result;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = this.state, values = _c.values, errors = _c.errors;
                        name = directName || event.target.dataset.name;
                        value = directName ? event : maybe('target.value', event);
                        nextState = {
                            values: __assign({}, values, (_a = {}, _a[name] = value, _a)),
                        };
                        if (!(errors[name] && !errors[name].valid)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.props.controller.validateByName(name, nextState.values)];
                    case 1:
                        result = _d.sent();
                        nextState['errors'] = __assign({}, errors, (_b = {}, _b[name] = result, _b));
                        _d.label = 2;
                    case 2:
...
function withValidation (controllerName) {
    return function (WrappedComponent) {
        return /** @class */ (function (_super) {
            ...
            function class_1(props) {
                ...
                var _this = _super.call(this, props) || this;
                _this.controller = (_a = {},
                    _a[controllerName] = new Controller(),
                    _a);
                return _this;
            }
            class_1.prototype.render = function () {
                return React__default.createElement(WrappedComponent, __assign({}, this.props, this.controller));
            };
            return class_1;
