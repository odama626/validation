...
var SimpleWrapper = /** @class */ (function (_super) {
    ...
    SimpleWrapper.prototype.render = function () {
        ...
        return (React.createElement(Context.Consumer, null, function (state) {
            ...
            return React.cloneElement(children, __assign((_a = { name: name, value: value }, _a['data-name'] = name, _a['data-error'] = error, _a['data-message'] = validate && validate.message, _a), rest));
        }));
    };
